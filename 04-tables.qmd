...
::: {#tbl-datatypes tbl-colwidths="[30,30,40]"}
...
::: {.callout-note title="Lookup Wizard Data Type"}
...
::: {.callout-note title="Input validation"}
...
::: {.callout-note title="Save storage space"}
Setting the second part to `1` can save database space.
:::

::: {#tbl-inputmask-symbols tbl-colwidths="[25,75]"}
| Character | Meaning |
|:---|:---|
...
: Input mask symbols and meanings
:::
...
::: {.callout-important title="List boxes and forms"}
...
::: {.callout-important title="Consequences of Enforcing Referential Integrity"}
...
::: {.callout-important title="AutoNumber Fields"}
...
::: {.callout-note title="Currency Format"}
...
::: {.callout-note title="Table Transport"}
