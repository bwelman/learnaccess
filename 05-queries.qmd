...
2.  Choose [tab Create \> Query Design (group Queries)]{.uicontrol}. Access creates a new blank query window and displays at the right side the dialog box ***Add Tables***.

![Dialog box Add Tables.](images/queries/q-show-table.png){#fig-q-show-table}

3.  Select table [Customers]{.varname}, click [Add Selected Tables]{.uicontrol}. The table [Customers]{.varname} has now been added to the query window.
...
2.  Choose [tab Create \> Query Design (group Queries)]{.uicontrol}. Access creates a new blank query window and displays the dialog box ***Add Tables*** (see @fig-q-show-table if necessary).

3.  Add successively the tables [OrderDetails]{.varname} and [Boxes]{.varname} to the query window.
...
3.  Add successively the tables [Customers]{.varname} and [Orders]{.varname} to the query window.
...
3.  Add tables [Orders]{.varname} and [OrderDetails]{.varname} to the query window.
...
3.  Add table [Pralines]{.varname} to the query window.
...
3.  Add table [Customers]{.varname} to the query window.
...
9.  click [Query Design \> Make Table (group Query Type)]{.uicontrol}. The dialog box ***Make Table*** opens.
