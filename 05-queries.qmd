...
::: {.callout-note title="Explanation of criteria"}
...
::: {.callout-note title="No need for an additional criterion"}
...
::: {.callout-note title="Field names in expressions"}
...
::: {.callout-note title="Properties of objects"}
...
::: {.callout-important title="Security risk of action queries"}
...
::: {.callout-important title="Caution with Update Queries"}
...
::: {.callout-note title="Field names and text in expressions"}
...
::: {.callout-note title="Query type change and its implications"}
...
::: {.callout-important title="Make a backup before running an update query"}
