...
::: {.callout-note title="How to use the Registration form"}
...
::: {.callout-note title="Calculation of BoxCosts"}
...
::: {.callout-note title="Why a Validation message?"}
