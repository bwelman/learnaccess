...
::: {.callout-tip title="Inserting field names"}
...
::: {.callout-tip title="Accessing the Property Sheet"}
...
12. With the frame selected, adjust the following properties in the [Property Sheet]{.uicontrol}:
    ...
    -   In the [Format]{.uicontrol} tab, set Width and Height to `1"` (Access may slightly adjust the dimensions).
    -   In the [Data]{.uicontrol} tab, set the [Control Source]{.uicontrol} to the field `Picture`.
