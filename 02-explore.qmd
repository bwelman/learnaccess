...
::: {.callout-note title="Primary Keys"}
...
::: {.callout-note title="Calculation of total number of boxes"}
...
::: {.callout-important title="Security warning"}
...
::: {.callout-note title="Document window options"}
...
::: {.callout-note title="Showing the order details"}
...
::: {.callout-note title="Design View of a form"}
...
::: {.callout-note title="Query result"}
...
::: {.callout-note title="Design View of a query"}
...
::: {.callout-note title="Design View of a report"}
...
::: {.callout-note title="Filter results"}
...
::: {.callout-note title="Filter options"}
...
::: {.callout-note title="Alternative to Enable/Disable Filter"}
...
::: {.callout-note title="Printing Design View"}
