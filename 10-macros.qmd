...
::: {.callout-caution title="Macros and security"}
...
4.  Drag the top edge of the [Detail]{.uicontrol} section downward to make space in the header.
...
::: {.callout-note title="Macro not created yet"}
...
::: {.callout-note title="Synchronizing combo boxes"}
...
::: {.callout-note title="Synchronization combo boxes"}
